...
import id.ridon.fileexplorer.FileListItem.ModeCallback;
import id.ridon.fileexplorer.FileOperationHelper.IOperationProgressListener;
import id.ridon.fileexplorer.FileSortHelper.SortMethod;
import id.ridon.fileexplorer.FileViewActivity.SelectFilesCallback;
import id.ridon.fileexplorer.TextInputDialog.OnFinishListener;
...
public class FileViewInteractionHub implements IOperationProgressListener {
    ...
    private id.ridon.fileexplorer.FileViewInteractionHub.Mode mCurrentMode;
